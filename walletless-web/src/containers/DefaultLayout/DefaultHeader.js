...
import logo from '../../assets/img/brand/W_Logo_text.svg'
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand
          full={{ src: logo, width: 125, height: 35, alt: 'WalletLess Logo' }}
          minimized={{ src: sygnet, width: 30, height: 30, alt: 'WalletLess Logo' }}
        />
